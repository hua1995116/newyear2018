(function ($) {
    ...
    var loop = function() {
        ...
        for (var i = 0; i < rockets.length; i++) {
            ...
            */
            // || rockets[i].vel.y >= 0 || distance < 50 || randomChance
    ...
    var launchFrom = function(x) {
        if (rockets.length < 1) {
            ...
            // rocket.explosionColor = 170;
            // 控制方向
            // rocket.vel.y = -4.446955609162547;
            // rocket.vel.x = -0.4021120904309661;
            rocket.size = 8;
            rocket.shrink = 0.999;
            rocket.gravity = 0.01;
            rockets.push(rocket);
    ...
    //     if(!launchTimer && !loopTimer){
    //         launchTimer = setInterval(launch, 800);
    //         loopTimer = setInterval(loop, 1000 / 50);
    //     }
    //     num++;
    // }
    launchTimer = setInterval(launch, 800);
